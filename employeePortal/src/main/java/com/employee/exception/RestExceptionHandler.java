...
//        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(RestApiResponse.builder().message("Validation Failed").errors(fieldErrors).timestamp(new Date()).build());
//    }
//}